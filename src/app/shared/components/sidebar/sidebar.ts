...
interface NavItem {
  label: string;
  route: string;
  svgPath: string;   // path data Heroicons 24 outline
...
export class SidebarComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    },
    {
      ...
      route: '/agents',
      roles: ['ADMIN', 'TECNICO'],
      svgPath: 'M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25A2.25 2.25 0 0 1 5.25 3h13.5A2.25 2.25 0 0 1 21 5.25z',
    },
    {
      label: 'Políticas',
      route: '/policies',
  ...
  get visibleItems(): NavItem[] {
    return this.navItems.filter(item =>
      !item.roles?.length || this.auth.hasRole(...item.roles)
    );
  }
}